...
function accederForm() {     
    ...
    // Creo el formulario con el objeto createElement
    var formulario = document.createElement("form");
    formulario.style.border = "solid pink";

    // Creo una función para crear un label y un imput por cada campo de entrada 
    ...
    // LLamo a la función para añadir los parámetros para cada label y cada input al formulario
    ...
    // Creo un contenedor para el radio
...
// Creo el array de imágenes
    let imagenes = [{ id: "opIm1", value: "e1", imageSrc: "imagenes/i1.jpg" }, { id: "opIm2", value: "e2", imageSrc: "imagenes/imagen2.jpg" }];
